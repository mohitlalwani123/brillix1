      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 text-white py-20">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            ...
            worksheets, and quizzes for all subjects
          </p>
        </div>
      </section>
              ...
              >
                ...
                <div className="p-8">
                  ...
                  <Link
                    ...
                    className="block w-full bg-blue-600 text-white text-center py-3 px-6 rounded-lg hover:bg-blue-700 transition-colors duration-300 font-semibold"
                  >
                    Access Materials
                  </Link>
                </div>
